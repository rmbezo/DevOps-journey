...
процессы и потоки, SIGINT, SIGTERM и т.д., Load Average, состояния процессов. Systemctl. Права и пользователи, файловая система, загрузка и инициализация. Ping, curl -I, ss -lntu/p, traceroute, ufw - uncomplicated firewall (работа с портами и доступами).  
